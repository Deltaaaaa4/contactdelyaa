...
class TableViewController: UITableViewController {
        ...
        override func viewWillAppear(_ animated: Bool) {
            do{
                if let data = UserDefaults.standard.data(forKey: "PersonPhoneArray"){
                    array = try JSONDecoder().decode([PersonPhone].self, from: data)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = array[indexPath.row].name + " " + array[indexPath.row].surname
        cell.detailTextLabel?.text = array[indexPath.row].phone
